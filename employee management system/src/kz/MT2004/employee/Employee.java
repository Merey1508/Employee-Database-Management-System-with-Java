...
public abstract class Employee { //abstract class to get access to data easier,
    ...
    public abstract String SpecialtyInfo(); //because none of specialties changes functionality of SpecialtylInfo
    //method, in every specialties changed only returning string text
